# Description: This file contains functions that handle the image drawing and preprocessing.
# It is expected to be run as a module. 
# If runned as the main function, it will run a demo of the image drawing and print the image array (1d).
